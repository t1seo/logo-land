...
2. Update both root README release badges and links, add an entry to [CHANGELOG.md](../CHANGELOG.md), and prepare English release notes. Keep the default README and GitHub About description in English.
