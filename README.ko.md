<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/Development-v0.6.0-a64b32?style=flat-square&amp;labelColor=f6f3ec" alt="미출시 개발 버전 0.6.0"></a>
...
<p align="center">
  <a href="README.md">English</a> · <a href="README.ko.md">한국어</a> · <a href="docs/README.ko.md">문서</a> · <a href="docs/gallery.ko.md">갤러리</a>
</p>

# Logo Land (로고랜드)

<p align="center"><img src="assets/logo-land-studio.png" alt="Logo Land 열린 프레임 심볼과 LOGO LAND 워드마크" width="200"></p>

**Codex와 대화하며 로고와 앱 아이콘 아트워크를 만드실 수 있습니다.**

<a id="샘플"></a><a id="샘플-10개"></a><a id="투명-배경-로고"></a>

[**전체 원본을 한 페이지에서 보기 →**](docs/gallery.ko.md)

이미지를 누르면 PNG 원본이 바로 열립니다.
...
현재 저장소는 **v0.6.0 개발 소스**이며, 정식 릴리스는 [v0.3.1](https://github.com/t1seo/logo-land/releases/tag/v0.3.1)입니다.
...
> 여러 프로젝트의 후보를 한 갤러리에서 앱 홈 화면·웹 헤더·16px 크기로 비교해 주세요. 고른 디자인의 형태는 유지하고 열린 부분만 넓혀 주세요.
